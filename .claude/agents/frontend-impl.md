...
name: frontend-impl
description: >
  Senior Angular frontend developer for Chairly. Implements domain features following
  chairly-frontend-domain patterns. Works exclusively in the provided worktree path.
