...
Spawn both QA agents:

**Backend QA:** Spawn `chairly-backend-qa`, append `BACKEND_WT: {BACKEND_WT}`
**Frontend QA:** Spawn `chairly-frontend-qa`, append `FRONTEND_WT: {FRONTEND_WT}`
